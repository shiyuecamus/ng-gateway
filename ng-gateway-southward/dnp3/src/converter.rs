//! Model converter for the DNP3 driver.
//!
...
use super::types::{
    Dnp3Action, Dnp3Channel, Dnp3CommandType, Dnp3Device, Dnp3Parameter, Dnp3Point, Dnp3PointGroup,
};
use ng_gateway_sdk::{
...
/// Default model converter for the DNP3 driver.
#[derive(Debug, Clone, Default)]
pub struct Dnp3Converter;

impl SouthwardModelConverter for Dnp3Converter {
