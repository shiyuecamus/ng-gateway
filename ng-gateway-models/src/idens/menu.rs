...
async fn get_menu_seed_data(_: &mut InitContext) -> Result<Option<Vec<NewMenuWithId>>, DbErr> {
    Ok(Some(vec![
        ...
        NewMenuWithId {
            ...
            component: "/northward/app/modules/widgets/observability".into(),
            sort: Some(99),
        ...
        NewMenuWithId {
            ...
            component: "/southward/channel/modules/widgets/observability".into(),
            sort: Some(99),
        ...
        NewMenuWithId {
            ...
            parent_id: 12,
            r#type: MenuType::Menu,
            path: Some("/maintenance/action-debug".into()),
            component: "/maintenance/action-debug/index".into(),
            sort: Some(3),
            title: "page.maintenance.action-debug.title".into(),
        ...
        NewMenuWithId {
            ...
            parent_id: 12,
            r#type: MenuType::Menu,
            path: Some("/maintenance/net-debug".into()),
            component: "/maintenance/net-debug/index".into(),
            sort: Some(4),
            title: "page.maintenance.netDebug.title".into(),
